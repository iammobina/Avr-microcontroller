...
; 0000 0021 input = PINA.0;
	LDI  R30,0
	SBIC 0x19,0
	LDI  R30,1
	MOV  R5,R30
; 0000 0022 if(input == 0)
	TST  R5
	BRNE _0x3
; 0000 0023 {
; 0000 0024     TIFR = 1<<TOV0;
	LDI  R30,LOW(1)
	OUT  0x38,R30
; 0000 0025     PORTA.1 ^=1;
	LDI  R26,0
...
; 0000 0037 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=Out Bit0=In
; 0000 0038 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (1<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(2)
	OUT  0x1A,R30
; 0000 0039 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=0 Bit0=T
...
; 0000 0050 // Clock value: 125.000 kHz
; 0000 0051 // Mode: CTC top=OCR1A
...
; 0000 005B TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
; 0000 005C TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (0<<CS12) | (1<<CS11) | (1<<CS10);
	LDI  R30,LOW(11)
	OUT  0x2E,R30
...
; 0000 0060 ICR1L=0x00;
	OUT  0x26,R30
; 0000 0061 OCR1AH=0xF4;
	LDI  R30,LOW(244)
	OUT  0x2B,R30
; 0000 0062 OCR1AL=0x23;
	LDI  R30,LOW(35)
	OUT  0x2A,R30
