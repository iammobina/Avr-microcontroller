...
;http://www.hpinfotech.com
;
;Project : The 9th Project
;Version : v1.0
;Date    : 7/7/2020
;Author  : Zahra Anvarian
;Company : IUST
;Comments:
;
;
...
; 0000 0026     if(PINC & (1<<PINC3)){
	SBIS 0x13,3
	RJMP _0x3
; 0000 0027         counter += 10;
	MOVW R30,R4
	ADIW R30,10
	RJMP _0xD
...
; 0000 0033     if(PINC & (1<<PINC3)){
	SBIS 0x13,3
	RJMP _0x5
; 0000 0034         counter -= 10;
	MOVW R30,R4
	SBIW R30,10
	RJMP _0xE
...
; 0000 0041    if(PINC & (1<<PINC3)){
	SBIS 0x13,3
	RJMP _0x7
; 0000 0042      PORTC &= ~(1<<PINC3);
	CBI  0x15,3
; 0000 0043    }else {
	RJMP _0x8
_0x7:
; 0000 0044      PORTC |= (1<<PINC3);
	SBI  0x15,3
; 0000 0045    }
_0x8:
; 0000 0046 }
...
; 0000 0096 // INT2: On
; 0000 0097 // INT2 Mode: Falling Edge
; 0000 0098 GICR|=0xE0;
	IN   R30,0x3B
	ORI  R30,LOW(0xE0)
	OUT  0x3B,R30
; 0000 0099 MCUCR=0x0A;
	LDI  R30,LOW(10)
	OUT  0x35,R30
...
; 0000 00B9 // RS - PORTC Bit 0
; 0000 00BA // RD - PORTC Bit 1
; 0000 00BB // EN - PORTC Bit 2
; 0000 00BC // D4 - PORTC Bit 4
; 0000 00BD // D5 - PORTC Bit 5
; 0000 00BE // D6 - PORTC Bit 6
; 0000 00BF // D7 - PORTC Bit 7
; 0000 00C0 // Characters/line: 16
; 0000 00C1 lcd_init(16);
	LDI  R26,LOW(16)
	RCALL _lcd_init
; 0000 00C2 
; 0000 00C3 DDRC |= (1<<PINC3);
	SBI  0x14,3
; 0000 00C4 
...
; 0000 00CB       lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 00CC       itoa(counter , temp) ;
	ST   -Y,R5
	ST   -Y,R4
	MOVW R26,R6
	CALL _itoa
; 0000 00CD       lcd_puts(temp) ;
	MOVW R26,R6
	RCALL _lcd_puts
